				...
				<div id="rights">
					...
					<div class="context">
						<div>
							...
							<span><a href="#"><strong
									style="font-size: 24px; color: #000">潮流化妆</strong> </a> </span>
							<span style="float: right;"><a href="#"><strong
									style="font-size: 13px; color: #999">女人的化妆天堂，尽在Gogo</strong> </a> </span>
							<hr />
							<P>
								&nbsp
							</P>
							...
							<ul class="infoList" style="list-style-type: none;">
								<c:forEach items="${sessionScope.goodlist}" var="goodss">
									<c:url value="/detailGood.jsp" var="goods">
										...
										<c:param name="gpic" value="huazhuang/${goodss.gpic}"></c:param>
									...
									<li>
										<a href="${goods}" title="点击查看" class="img"><img
												src="/shopping/upfile/huazhuang/${goodss.gpic}" width="1188"
												height="592" /> </a>
