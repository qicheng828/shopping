				...
				<div id="rights">
					...
					<div class="context">
						<div>
							...
							<span><a href="#"><strong
									style="font-size: 24px; color: #000">时尚服装</strong> </a> </span>
									<span>
							...
							<span style="float: right;"><a href="#"><strong
									style="font-size: 13px; color: #999">时尚服装，超级耐看</strong> </a> </span>
							<hr />
							<P>
								&nbsp
							</P>
							...
							<ul class="infoList" style="list-style-type: none;">
								<c:forEach items="${sessionScope.goodlist}" var="goodss">
									<c:url value="/detailGood.jsp" var="goods">
										...
										<c:param name="gpic" value="yifu/${goodss.gpic}"></c:param>
									...
									<li>
										<a href="${goods}" title="点击查看" class="img"><img
												src="/shopping/upfile/yifu/${goodss.gpic}" width="1188"
												height="592" /> </a>
