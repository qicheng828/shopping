...
$("document").ready(function (){
		...
		$("#upass").blur(function(){
			  $.post("usersAction_LookPassword.action",{"password":$(this).val()},function(data){
			    if(data=="false"){
			    alert("旧密码输入错误!")
			     $("#upassError").css('color','red').html("旧密码输入错误!");
			    }
			  });
			});
	});
...
<div id="right" style="width:780px; margin-bottom:10px;">
            ...
            <div style="background-image:url(/shopping/images/users/Snap5.jpg);background-repeat:repeat-y;padding-bottom:30px;">
			 <div id="xinxi">
                         ...
                         <form action="/shopping/usersAction_UpPassword.action" method="post" id="textForm">
                     	 <div class="mima">
                     	 <input style="display: none;" type="text" name="uid" value="${sessionScope.users.uid}" id="ids"/>
                         	<span>我的旧密码：</span>
                            <span style="margin-left:42px;"><input type="password" name="password" id="upass"/></span>
