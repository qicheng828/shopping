	...
	<body>
		<div style="width: 980px; margin: 0px auto;">
			...
			<div id="mid" style="margin-bottom: 20px;">
				...
				<div id="showCar">
					...
					<div class="ftotal" style="padding-right: 9px;">
						...
						<a href="javascript:remove()" id="remove"><img
								style="margin: 0px 5px 3px;"
								src="/shopping/images/car/goClear.jpg" />
						</a>
					   <c:choose>
			...
			<div id="bot">
				...
				<p>
					Tel: (027) 63165989 Fax: (027) 62658785 Email:chen_songyang@sina.com
					鄂ICP证090719号
				</p>
				<p>
					本网站隶属于小企科技旗下网站
