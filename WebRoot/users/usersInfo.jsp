            ...
            <div style="background-image:url(/shopping/images/users/Snap5.jpg);background-repeat:repeat-y;padding-bottom:30px;">
			 <div id="xinxi">
                            ...
                            <p>帮助我们完善您的个人信息，有助于我们未来根据您的情况提供更加个性化的服务；Gogo商城会对您的个人隐私资料加以保密。</p>
                     		<form action="/shopping/usersAction_UpUser.action" method="post" name="myform" id="myform">
                                <div class="bo">
                                <input style=" display: none;" type="text" name="users.uid" value="${sessionScope.users.uid}" />
                                	<label>真实姓名：</label>
                                	<input type="text"size="20" name="users.uname" id="uname" maxlength="10" value="${sessionScope.users.uname}" />
                                </div>
                                <div class="bo">
                               	  	<label>手机号码：</label>
                                	<input type="text" size="20" name="users.uphone" id="uphone" maxlength="16" value="${sessionScope.users.uphone}"/>
                                </div>
                              	<div class="bo">
                               		<label>电子邮件：</label>
                                	<input type="text" size="30" name="users.uemail" id="uemail" maxlength="20" value="${sessionScope.users.uemail}" />
                                	<span></span>
                              	</div>
                              	<div class="bo">
                                	<label>所在省市：</label>
                              	...
                              	<div class="bo">
                                	<label>详细地址：</label>
                                	<input type="text" size="30" name="users.uaddress" id="uaddress" maxlength="10" value="${sessionScope.users.uaddress}"/>
                                	<span></span>
                              	</div>
                              	<div class="bo">
                                	<label>邮政编码：</label>
                                	<input type="text" size="30" name="users.upost" id="upost" maxlength="10" value="${sessionScope.users.upost}"/>
                                	<span></span>
                              	</div>
                                <div class="bo">
