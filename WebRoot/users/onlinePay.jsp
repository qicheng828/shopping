...
#showCar #forderInfo p {
	margin: 10px 0px;
}

#showCar #forderInfo p span {
	margin-right: 8px;
}
...
#showCar #goPay input {
	background-image: url(/shopping/images/car/okPay.jpg);
	border: 0px;
	width: 126px;
	height: 32px;
}
		...
		<div style="width: 980px; margin: 0px auto;">
				...
				<div id="showCar">
					<form action="/shopping/onpayAction_onpays.action" method="post">
						...
						<div id="forderInfo">
							...
							<p>
								<span>送货地址：</span><span>${sessionScope.payForder.uaddress
									}</span>
							</p>
							<p>
						...
						<div id="pay">
							...
							<span style="margin-left: 40px; color: #0077FF;"><a
								href="#" style="color: #0077FF;">如何使用?</a> </span>
						...
						<div>
							<h1
								...
								<img style="float: right"
									src="/shopping/images/car/top-right.jpg" />
							</h1>
							<div id="paybank" style="clear: both">
								...
								<table
									...
									<tr>
										<c:forEach items="${applicationScope.logo}" var="log"
											varStatus="num">
											<td>
												<input type="radio" checked="checked" name="onpay.pd_FrpId"
													value="${fn:substring(log,0,fn:indexOf(log,'.'))}" />
											</td>
											<td width="180">
								...
								<div>
									...
									<span style="margin-left: 30px;"><a href="#"
										style="color: #0077FF;">如何开通?</a> </span>
						...
						<div id="goPay" style="padding-right: 9px;">
							...
							<input type="hidden" name="ftotal"
								value="${sessionScope.payForder.ftotal }" />
							<input type="hidden" name="fid"
								value="${sessionScope.payForder.fid}" />
							<input type="hidden" name="onpay.p0_Cmd" value="Buy" />
							<input type="hidden" name="onpay.p1_MerId " value="10000940764" />
							<input type="hidden" name="onpay.p2_Order "
								value="${sessionScope.forder.fid }" />
							<input type="hidden" name="onpay.p3_Amt "
								value="${sessionScope.forder.ftotal}" />
							<input type="hidden" name="onpay.p4_Cur " value="CNY" />
							<input type="hidden" name="onpay.p8_Url "
								value="<%=request.getContextPath()%>/onpay_success.action" />
			...
			<div id="bot">
				...
				<div id="info">
					<p>
						Copyright ©
						<a href="/shopping/index.jsp">Gogo</a> 2010-2012, All Rights
						Reserved
					</p>
					<p>
