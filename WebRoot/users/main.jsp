...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="/shopping/css/index/index.css" rel="stylesheet"
			type="text/css" />
		<link href="/shopping/index/index.css" rel="stylesheet"
			type="text/css" />
		<style type="text/css">
* {
	margin: 0px;
...
.dingdan {
	background-image: url(/shopping/images/users/users-mid.jpg);
	height: 100px;
	padding: 10px;
}
					...
					<div style="width: 980px; margin: 0px auto;">
						<div id="top">
							...
							<div id="menu">
								...
								<img style="float: right"
									src="/shopping/images/index/menu-r.gif" />
								<ul>
									<li>
									...
									<li class="img">
										<img style="float: left;"
											src="/shopping/images/index/split.jpg" />
									</li>
						...
						<div
							style="background-image: url(/shopping/images/users/bg.jpg); height: 27px; border: 1px solid #cccccc; margin: 20px 0px;">
					...
					<table width="100%" height="133" border="0" cellpadding="0"
						...
						<tr>
							<td width="20%" align="left" valign="top">
								<iframe name="I1" height="680" width="100%"
									src="/shopping/users/left.jsp" border="0" frameborder="0"
									scrolling="no">
									浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
								</iframe>
							</td>
							<td width="80%" align="left" valign="top">
								<iframe name="right" height="680" width="100%"
									src="/shopping/users/test.jsp" border="0" frameborder="0"
									scrolling="no">
									浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
								</iframe>
							</td>
					...
					<div style="width: 980px; margin: 0px auto;">
						<div id="bot">
							...
							<div id="info">
								<p>
									Copyright ©
									<a href="../front/index.html">Gogo</a> 2010-2012, All Rights
									Reserved
								</p>
								<p>
